...
// arguments keyword  есть во всех функциях кроме стрелочных
// const exprSum = function (a, b) {
...
const saraCopy = Object.assign({}, sara); // метод создает копию объекта sara и помещает ее в новый объект, работает только на 1 уровне объекта
saraCopy.lastName = 'White';
saraCopy.familyMembers.push('Bill', 'Marta'); // поместит новых членов семьи в оба объекта
